...
const LotteryCard: React.FC<PropsType> = ({ infos }) => {
    ...
    return (
        <Container>
            ...
            {/* Buttons */}
            <BtnCompleteGame data-cy="btnComplete" onClick={completeGameHandler}>Complete game</BtnCompleteGame>
            <BtnClearGame data-cy="btnClear" onClick={clearGameHandler}>Clear game</BtnClearGame>
            <BtnAdd data-cy="btnAdd" onClick={AddCartHandler}>
